    ...
    impl = {
        ...
        buildSNSParams: function(topicArn, subject, report) {
          ...
          if (typeof report !== "string") {
            reportStr = JSON.stringify(reportStr);  
          }
          var snsParams = {
            TopicArn: topicArn,
            Subject: subject,
        ...
        SNSPlugin: function(scriptConfig, eventEmitter) {
           var self = this,
            ...
            eventEmitter.on('done', function (report) {
                var snsParams = impl.buildSNSParams(self.config[constants.PLUGIN_PARAM_TOPICARN], self.config[constants.PLUGIN_PARAM_SUBJECT] || "Artillery Report", report);
